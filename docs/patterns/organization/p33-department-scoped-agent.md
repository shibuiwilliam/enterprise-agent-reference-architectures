...
!!! abstract "メタ"
    **カテゴリ**: 組織 ／ **対象**: 従業員 ／ **成熟度**: 標準 ／ **関連**: [P14](../memory/p14-semantic-layer.md), [P16](../orchestration/p16-supervisor-router.md), [P36](../governance/p36-digital-employee-lifecycle.md)

**トリガ（採用検討の条件）**: 部署ごとに業務・ツール・規制が大きく異なる。
...
- **向き**: 部署ごとに業務・ツール・規制が大きく異なる大企業。
- **不向き**: 横断業務が大半で部署境界が意味をなさない組織。
